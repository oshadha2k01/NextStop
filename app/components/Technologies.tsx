      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {technologies.map((tech, i) => (
            <div key={i} className="bg-white p-8 rounded-2xl border-2 border-gray-100 text-center hover:border-[#FF6B35] transition-colors flex flex-col items-center group cursor-pointer">
